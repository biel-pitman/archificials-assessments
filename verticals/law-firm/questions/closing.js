 ...
 * These appear after every practice area module.
 */
export const CLOSING_QUESTIONS = [
  {
    ...
    required: true,
    options: [
      "They wait until the next business day (voicemail or form submission)",
      "A third-party answering service takes the call",
      "We have an after-hours emergency line handled by staff",
  ...
  },
  {
    ...
    label: "CL2",
    category: "CLIENT RESPONSIVENESS",
    question: "From the moment someone first contacts your firm to a signed engagement agreement, how long does intake typically take?",
    type: "single-select",
    required: true,
    options: [
  ...
  },
  {
    ...
    question: "How urgently does your firm need to address the gaps you've identified through this assessment?",
    type: "scale",
    required: true,
    min: 1,
    max: 5,
  ...
  },
  {
    ...
    subtitle: "A specific challenge, competitive pressure, or context that would be useful to know.",
    type: "textarea",
    required: false,
  },
];
